...
public class GraphM4A {
	...
	public GraphM4A(Scanner sc) {
		...
		for (int k = 0; k < this.n; k++) {
			...
			if (weighted == 0) {
				...
				line = line[1].split(" // ");
				if ((line.length == 2) && (line[1].charAt(0) != ' ')) {// if there really are some successors, then we
	...
	/**
	 * TP1 Exercise 1 Compute the transposed graph, represented by an adjacency
	 * matrix
	 */
	...
	/**
	 * TP1 Exercise 1 Compute the transposed graph, represented by an unweighted
	 * adjacency list
	 */
	...
	/**
	 * TP1 Exercise 1 Compute the transposed graph, represented by a weighted
	 * adjacency list
	 */
